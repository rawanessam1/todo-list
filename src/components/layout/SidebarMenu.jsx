...
const SidebarMenu = () => {
  return (
    <div className="w-64 bg-color-lightGray2 shadow-md rounded-3xl p-6 flex flex-col justify-between">
      <div>
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold">Menu</h2>
          <MenuOutlined className="text-xl" />
        </div>
        <Input prefix={<SearchOutlined />} placeholder="Search..." className="rounded-full mb-6"/>
        <div className="mb-6">
          <h3 className="font-semibold mb-3">Tasks</h3>
          <ul className="space-y-3">                    {/* for space between children */}
            <li className="flex justify-between">
              <span><MdKeyboardDoubleArrowRight /> Upcoming</span>
              <span className="bg-gray-200 text-xs px-2 py-1 rounded-full">15+</span>
            </li>
            <li className="flex justify-between">
              <span><TfiMenuAlt /> Today</span>
              <span className="bg-gray-200 text-xs px-2 py-1 rounded-full">8</span>
            </li>
